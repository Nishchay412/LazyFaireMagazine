    ...
    <div>
      ...
      <div className="bg-[url('/backgroundimage.png')] h-screen bg-cover bg-center">
        ...
        <div className="flex flex-col  items-center justify-center h-full">
          {/* Magazine Cover */}
          <motion.div
            className="w-auto h-auto max-w-xs max-h-[75vh] object-contain rounded-lg shadow-lg py-2"
          ...
          {/* Button Section */}
          <button
            className="mt-4 bg-transparent text-white font-bold text-xl px-6 py-2 rounded-lg shadow-md hover:bg-white hover:text-black  duration-300 transition duration-300 relative overflow-hidden"
            onClick={() => {
